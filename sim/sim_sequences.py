...
def create_recombinant(seq1, seq2):
    ...
    # If not,
        ...
        if recombinant_sequence == seq1 or recombinant_sequence == seq2:
            return False, False
...
while len(recombinant_numbers_list) < args.n_single:
    ...
    if recombinant_sequence != False:
        ...
        final_recombinant_numbers = mutate_numeric_sequence(recombinant_numbers, mutation_rate=args.rate)
...
while len(control_numbers_list) < args.n_control:
    ...
    final_nonrecombinant_numbers = mutate_numeric_sequence(seq1_numbers, mutation_rate=args.rate)
